...
#### 1 - Exiba apenas os nomes do produtos da tabela `products`.

#### 2 - Exiba os dados de todas as colunas da tabela `products`.

#### 3 - Escreva uma query que exiba os valores da coluna que contém a primary key da tabela `products`.

#### 4 - Conte quantos registros existem na coluna `product_name` de `products`.
...
#### 12 - Mostre os resultados da coluna `submitted_date` de `purchase_orders` em que a `submitted_date` é do dia 26 de abril de 2006.
